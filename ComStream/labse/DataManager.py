...
class DataManager:
    ...
    def __init__(self, data_file_path, data_embedding_path, count: int, epsilon=1e-7):
        """
    ...
    def load_data(self, file_path: str, data_embedding_path: str, count: int) -> None:
        """
    ...
    def get_twitter_dp(self, dp: pd.DataFrame, embedding_vec) -> TwitterDataPoint:
        """
